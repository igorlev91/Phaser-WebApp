    ...
    <>
      <div className="flex-container-column">
        <div className="hero-container">
          <div className="hero">
            <h1>A look into levdev&#39;s target spawning system</h1>
        ...
        <div className="flex-container-row">
          ...
          <article className="flex-container-column" id="article">
            <p>
              I wrote this article with the goal that the reader doesn&#39;t need to understand C++ to grasp the main concepts that levdev
            ...
            <div className="article-section" ref={Ref_Classes} id="classes-header">
              ...
              <p>
                This section gives a brief description of all classes involved in levdev&#39;s target spawning system and establishes the
...
igorlev91/levdev/blob/develop/Source/levdev/Public/Target/SpawnAreaManagerComponent.h"
                />
                <p>
              ...
              <div className="article-subsection" ref={Ref_ATargetManager} id="classes-ATargetManager">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/Target/TargetManager.cpp"
                />
                <p>
                ...
                <div className="article-subsection-2" ref={Ref_UReinforcementLearningComponent} id="classes-UReinforcementLearningComponent">
                  <BlogHeadingClass
                    ...
                    headingLevel={3}
                    childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/Target/ReinforcementLearningComponent.cpp"
                  />
                ...
                <div className="article-subsection-2" ref={Ref_USpawnAreaManagerComponent} id="classes-USpawnAreaManagerComponent">
                  <BlogHeadingClass
                    ...
                    headingLevel={3}
                    childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/Target/SpawnAreaManagerComponent.cpp"
                  />
              ...
              <div className="article-subsection" ref={Ref_ATarget} id="classes-ATarget">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/Target/Target.cpp"
                />
                <p>
...
igorlev91/levdev/blob/develop/Source/levdev/Private/Character/BSHealthComponent.cpp"
              ...
              <div className="article-subsection" ref={Ref_ABSGameMode} id="classes-ABSGameMode">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/BSGameMode.cpp"
                />
                <p>
            ...
            <div className="article-section" ref={Ref_TargetLifeCycle} id="target-lifecycle">
              ...
              <div className="article-subsection" ref={Ref_Spawning} id="target-lifecycle-Spawning">
                ...
                <p>
                  There are two spawning methods in levdev: <BSInlineEnum className={"ETargetSpawningPolicy"} valueName={"UpfrontOnly"} />{" "}
