    ...
    <>
      <div className="flex-container-column">
        <div className="hero-container">
          <div className="hero">
            <h1>An Overview of Unreal&#39;s Gameplay Ability System in levdev</h1>
            <p className="hero-lead">
              How is the Gameplay Ability System used in levdev? This article shows the implementation and walks through the execution of
              a common ability.
            </p>
        ...
        <div className="flex-container-row">
          ...
          <article className="flex-container-column" id="article">
            ...
            <p>
              ...
              levdev. Shooting a weapon could have easily been accomplished without a framework, and it was that way at first. However, I
            ...
            <p>
              This article lays out exactly how I&#39;ve implemented <span className="inline text-light">GAS</span> in levdev. I&#39;ve
            ...
            <div className="article-section" ref={Ref_gasC} id="gas-classes">
              ...
              <div className="article-subsection" ref={Ref_gasC_asc} id="classes-UAbilitySystemComponent">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/AbilitySystem/BSAbilitySystemComponent.cpp"
                />
                <p>
                  The Ability System Component (<span className="text-light">ASC</span>) is added to any actor that wants to interact with{" "}
                  <span className="text-light">GAS</span>. For levdev, the only actors that have <span className="text-light">ASCs</span>{" "}
              ...
              <div className="article-subsection" ref={Ref_gasC_ga} id="classes-UGameplayAbility">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Abilities/BSGameplayAbility.cpp"
                />
                <p>
                ...
                <div className="article-subsection-2" id="classes-UBSGA_FireGun">
                  <BlogHeadingClass
                    ...
                    headingLevel={3}
                    childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Abilities/BSGA_FireGun.cpp"
                  />
                  <p>
                ...
                <div className="article-subsection-2" id="classes-UBSGA_TrackGun">
                  <BlogHeadingClass
                    ...
                    headingLevel={3}
                    childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Abilities/BSGA_TrackGun.cpp"
                  />
                  <p>
                  ...
                  <div className="article-subsection-2" id="classes-UBSAT_TickTrace">
                    <BlogHeadingClass
                      ...
                      childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Tasks/BSAT_TickTrace.cpp"
                    />
                    <p>
                ...
                <div className="article-subsection-2" id="classes-UBSGA_AimBot">
                  <BlogHeadingClass
                    ...
                    headingLevel={3}
                    childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Abilities/BSGA_AimBot.cpp"
                  />
                  <p>
                    Before levdev&#39;s trailer was edited, I needed footage of the game in action but didn&#39;t want to worry about
...
igorlev91/levdev/blob/develop/Source/levdev/Private/Player/BSCheatManager.cpp"
                    >
                  ...
                  <div className="article-subsection-2" id="classes-UBSAT_AimToTarget">
                    <BlogHeadingClass
                      ...
                      headingLevel={4}
                      childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Tasks/UBSAT_AimToTarget.cpp"
                    />
                    <p>
              ...
              <div className="article-subsection" ref={Ref_gasC_asb} id="classes-UBSAttributeSetBase">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Globals/BSAttributeSetBase.cpp"
                />
                <p className="">
                  An Attribute Set is a group of stats that an actor with an <span className="text-light">ASC</span> has. levdev has
                ...
                <p className="">
                  ...
                  exist on the server and are used in levdev to calculate the damage that should be applied to a target.
                </p>
                <ul>
              ...
              <div className="article-subsection" ref={Ref_gasC_ge} id="gameplay-effects">
                ...
                <p>
                  Any damage that is dealt in levdev is applied using an instant duration <span className="text-light">GE</span>. This is
              ...
              <div className="article-subsection" ref={Ref_gasC_eic} id="classes-UBSInputComponent">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/Input/BSInputComponent.cpp"
                />
                <p>
                ...
                <div className="article-subsection" ref={Ref_gasC_eic_ic} id="classes-UBSInputConfig">
                  <BlogHeadingClass
                    ...
                    headingLevel={3}
                    childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/Input/BSInputConfig.cpp"
                  />
                  <p>
                  ...
                  <figure className="max-width-1000">
                    <div className="figure-border-container" id="figure-1">
                      ...
                      <figcaption>
                        ...
                        The input configuration for a character in levdev.
                      </figcaption>
                    </div>
                  </figure>
                </div>
              ...
              <div className="article-subsection" ref={Ref_gasC_as} id="classes-UBSAbilitySet">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Globals/BSAbilitySet.cpp"
                />
                <p>
              ...
              <div className="article-subsection" ref={Ref_gasC_dec} id="classes-UBSDamageExecCalc">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/AbilitySystem/ExecutionCalculations/BSDamageExecCalc.cpp"
                />
                <p>
              ...
              <div className="article-subsection" ref={Ref_gasC_hc} id="classes-UBSHealthComponent">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/
igorlev91/levdev/blob/develop/Source/levdev/Private/Character/BSHealthComponent.cpp"
                />
                <p>
            ...
            <div className="article-section" ref={Ref_tl} id="timeline">
              ...
              <p>
                For this section, I detail what happens when the player in levdev shoots a target in a Hit-Based damage game mode,
                ...
                <div className="article-subsection-2" ref={Ref_tl_aa_otdrc} id="timeline-OnTargetDataReadyCallback">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      weapon’s fire rate, but there is no cost to firing the weapon since levdev’s weapons have unlimited ammo. If{" "}
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <ul>
                            <li>
                              <FontAwesomeIcon icon={faCrosshairs} className="li-icon" />
                              As previously mentioned, levdev uses two types of damage: Hit and Tracking. These attributes are snapshotted
            ...
            <div className="article-section" ref={Ref_conclusion} id="conclusion">
              ...
              <p>
                levdev&#39;s abilities are pretty simple, so it does not take full advantage of everything{" "}
                <span className="inline text-light">GAS</span> has to offer. However, I do not believe it was a waste of time to implement.
                Adding new abilities is a breeze once everything is set up. If levdev were to ever offer multiplayer in the future, the
              ...
              <p>
                ...
                <Link
                  href="https://github.com/
igorlev91/levdev/commit/33a788d180c8666ca45f27d3b6b102ec2e324901"
                ...
                <Link
                  href="https://github.com/
igorlev91/levdev/commit/9c7feb6769ed34e0a6379d20f04a599a4adcc5c3"
                  className="link text-lightgrey hover-blue"
                >
                  here
                </Link>
                ...
                <Link className="link text-lightgrey hover-blue" href="mailto: mark@levdev.gg">
                  send me an email
                </Link>{" "}
