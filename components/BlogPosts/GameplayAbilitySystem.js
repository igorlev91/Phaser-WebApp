      ...
      <div className="flex-container-column">
        <div className="hero-container">
          <div className="hero">
            ...
            <p className="hero-lead">
              Why is the Gameplay Ability System used in levdev? This article explains the role of GAS and provides a walkthrough of a
              common ability.
            </p>
        ...
        <div className="flex-container-row">
          ...
          <article className="flex-container-column" id="article">
            ...
            <p>
              It might not sound like the Gameplay Ability System (GAS) has a reason to be in levdev. However, the two damage types in
              levdev (hit and tracking) are separate abilities created in the framework. Shooting a weapon could have easily been
            ...
            <div className="article-section" ref={Ref_0} id="gas-subclasses">
              ...
              <p>
                ...
                necessary classes that levdev overrides.
              </p>
              <div className="article-subsection" ref={Ref_1} id="classes-UAbilitySystemComponent">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/markoleptic/levdev/blob/develop/Source/levdev/Private/AbilitySystem/BSAbilitySystemComponent.cpp"
                />
                <p>
                  The Ability System Component (ASC) is added to any actor that wants to interact with GAS. For levdev, the only actors
              ...
              <div className="article-subsection" ref={Ref_2} id="classes-UGameplayAbility">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/markoleptic/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Abilities/BSGameplayAbility.cpp"
                />
                ...
                <div className="article-subsection-2" ref={Ref_3} id="classes-UBSGameplayAbility_FireGun">
                  <BlogHeadingClass
                    ...
                    headingLevel={3}
                    childClassLink="https://github.com/markoleptic/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Abilities/BSGameplayAbility_FireGun.cpp"
                  />
                  <p>
                ...
                <div className="article-subsection-2" ref={Ref_4} id="classes-UBSGameplayAbility_TrackGun">
                  <BlogHeadingClass
                    ...
                    headingLevel={3}
                    childClassLink="https://github.com/markoleptic/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Abilities/BSGameplayAbility_TrackGun.cpp"
                  />
                  <p>
              ...
              <div className="article-subsection" ref={Ref_5} id="classes-UBSAttributeSetBase">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/markoleptic/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Globals/BSAttributeSetBase.cpp"
                />
                <p className="">
                  An Attribute Set is a group of stats that an actor with an AbilitySystemComponent has. levdev has several attributes,
                ...
                <p className="">
                  ...
                  attributes. Meta attributes only exist on the server and are used in levdev to calculate the damage that should be
                  applied to a target.
                </p>
                <ul>
            ...
            <div className="article-section" ref={Ref_6} id="gameplay-effects">
              ...
              <p>
                Any damage that is dealt in levdev is applied using an instant duration GE. This is discussed further in the
            ...
            <div className="article-section" ref={Ref_7} id="additional-classes">
              ...
              <div className="article-subsection" ref={Ref_8} id="classes-UBSAbilitySet">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/markoleptic/levdev/blob/develop/Source/levdev/Private/AbilitySystem/Globals/BSAbilitySet.cpp"
                />
                <p>
              ...
              <div className="article-subsection" ref={Ref_9} id="classes-UBSInputComponent">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/markoleptic/levdev/blob/develop/Source/levdev/Private/Input/BSInputComponent.cpp"
                />
                <p>
                ...
                <div className="article-subsection" ref={Ref_10} id="classes-UBSInputConfig">
                  <BlogHeadingClass
                    ...
                    headingLevel={3}
                    childClassLink="https://github.com/markoleptic/levdev/blob/develop/Source/levdev/Private/Input/BSInputConfig.cpp"
                  />
                  <p>
              ...
              <div className="article-subsection" ref={Ref_11} id="classes-UBSDamageExecCalc">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/markoleptic/levdev/blob/develop/Source/levdev/Private/AbilitySystem/ExecutionCalculations/BSDamageExecCalc.cpp"
                />
                <p>
              ...
              <div className="article-subsection" ref={Ref_12} id="classes-UBSHealthComponent">
                <BlogHeadingClass
                  ...
                  headingLevel={2}
                  childClassLink="https://github.com/markoleptic/levdev/blob/develop/Source/levdev/Private/Character/BSHealthComponent.cpp"
                />
                <p>
            ...
            <div className="article-section" ref={Ref_13} id="timeline">
              ...
              <p>
                For this section, I wanted to detail exactly what happens when the player in levdev shoots a target in a Hit-Based. This
                ...
                <div className="article-subsection-2" ref={Ref_17} id="timeline-OnTargetDataReadyCallback">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      no cost to firing the weapon since levdev’s weapons have unlimited ammo. If{" "}
