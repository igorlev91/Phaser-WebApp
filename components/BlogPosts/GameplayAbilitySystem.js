				...
				<div className="hero-container">
					<div className="hero">
						...
						<p className="hero-lead">
							How is the Gameplay Ability System used in levdev? This article shows the implementation
				...
				<div className="flex-container-row">
					...
					<article className="flex-container-column" id="article">
						...
						<p>
							...
							in levdev. Shooting a weapon could have easily been accomplished without a framework, and
						...
						<p>
							...
							<span className="inline text-light">GAS</span> in levdev. I&#39;ve tried to be thorough so
						...
						<div className="article-section" ref={Ref_gasC} id="gas-classes">
							...
							<p>
								...
								to be subclassed in C++. In this section, I&#39;ll introduce each class that levdev
							...
							<div className="article-subsection" ref={Ref_gasC_asc} id="classes-UAbilitySystemComponent">
								...
								<p>
									...
									levdev, the only actors that have <span className="text-light">ASCs</span> are the
							...
							<div className="article-subsection" ref={Ref_gasC_asb} id="classes-UBSAttributeSetBase">
								...
								<p className="">
									...
									<span className="text-light">ASC</span> has. levdev has several attributes,
								...
								<p className="">
									...
									used in levdev to calculate the damage that should be applied to a target.
								</p>
								<ul>
							...
							<div className="article-subsection" ref={Ref_gasC_ge} id="gameplay-effects">
								...
								<p>
									Any damage that is dealt in levdev is applied using an instant duration{" "}
								...
								>
									...
									<ul>
										...
										<li>
											...
											since levdev’s weapons have unlimited ammo. If{" "}
						...
						<div className="article-section" ref={Ref_conclusion} id="conclusion">
							...
							<p>
								...
								everything is set up. If levdev were to ever offer multiplayer in the future, the
