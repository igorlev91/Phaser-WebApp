          ...
          <div className="card-container gap-1rem padding-1rem">
            <Link className="link" href="/devblog/target-spawning-system">
              <div className="card">
                ...
                <div className="card-label">A look into levdev&#39;s target spawning system</div>
          ...
          >
            <Link className="link" href="/devblog/target-spawning-system">
              <div className="card">
                ...
                <div className="card-label">An Overview of Unreal&#39;s Gameplay Ability System in levdev</div>
                <p className="card-sub-label">
                  How is the Gameplay Ability System used in levdev? This article shows the implementation and walks through the execution
                  of a common ability.
                </p>
              </div>
            </Link>
