...
import Timing from "../public/levdevTiming_large.png";
      ...
      <div className="flex-container-column gap-1rem padding-1rem">
        ...
        <div className="home-centered-bordered-container">
          <p className="fs-400 text-center ff-readable">
            levdev is rhythm-based aim-trainer that syncs targets to your music. Create custom game modes, view your stats, and make
          ...
          <div className="pn-container">
            <ul>
              ...
              <li>
				...
				<ul>
				<p>
                levdev leverages the power of reinforcement learning to dynamically predict target spawn locations tailored to your unique
                playstyle.
              </p>
              <p>
